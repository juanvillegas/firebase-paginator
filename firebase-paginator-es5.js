...
var isBrowser = (typeof global === 'undefined' ? 'undefined' : _typeof(global)) != 'object' || _typeof(global.process) != 'object';
...
function FirebasePaginator(ref, defaults) {
  ...
  var events = {};
  var fire = function fire(eventName, payload) {
  ...
  if (!isFinite) {
    ...
    this.previous = function () {
      return setPage(this.cursor).then(function () {
